...
class UNet(nn.Module):
    def __init__(self, kernel_size):
        ...
        self.bottle_neck = DoubleConv2d(512, 1024, kernel_size=3, batch=False, maxpool=False)

        self.upconv1 = UnetUpDoubleConv2d(1024, 512, kernel_size=kernel_size, padding=kernel_size//2)
        self.upconv2 = UnetUpDoubleConv2d(512, 256, kernel_size=kernel_size, padding=kernel_size//2)
        self.upconv3 = UnetUpDoubleConv2d(256, 128, kernel_size=kernel_size, padding=kernel_size//2)
        self.upconv4 = UnetUpDoubleConv2d(128, 64, kernel_size=kernel_size, padding=kernel_size//2)
